...
pairs = [
    ...
    [
        r"what is your name ?",
        ["My name is Investo. How can I help?",]
    ],
    [
        r"how are you  ?",
        ["I'm doing good\nHow bout you ?",]
